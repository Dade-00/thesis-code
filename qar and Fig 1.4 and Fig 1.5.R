setwd("C:/Users/acer/OneDrive - Alma Mater Studiorum Università di Bologna/Desktop/Unifi/stat economica/Progetto Presenti")
...
# Lag della variabile indipendente
y_lag <- stats::lag(y_adj_stl, +1)  

# Rimuove NA iniziale causato dal lag
